...
const VoyagerDetails = () => {
  ...
  return (
    <Container maxW='5xl' p='5rem'>
      <Heading mb='3rem' as='h1'>Voyager Details</Heading>
      <Stack direction='column' spacing='1.5rem' mb='3rem'>
        <FormTextField label='Voyager ID' name='id' value={data.id} onChange={handleChange} error={inputError} errorMessage='Invalid ID' />
