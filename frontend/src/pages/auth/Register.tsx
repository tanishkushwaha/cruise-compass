  ...
  return (
    <>
      <Flex justifyContent='center' alignItems='center' h='100vh'>
        <Box w='70rem' boxShadow='0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19)'>
          <Grid templateColumns='repeat(12, 1fr)'>
            ...
            <GridItem colSpan={{ base: 12, md: 6 }} p='2rem'>
              <Heading letterSpacing={1} mb='3rem'>Register</Heading>
              <Flex direction='column' gap={4}>
                <Flex gap={4}>
                  <FormInput label='First Name' name='firstName' type='text' value={data.firstName} onChange={handleChange} error={errors.firstName} />
                  <FormInput label='Last Name' name='lastName' type='text' value={data.lastName} onChange={handleChange} error={errors.lastName} />
                </Flex>
                <FormInput label='Phone' name='phone' type='tel' value={data.phone} onChange={handleChange} error={errors.phone} />
