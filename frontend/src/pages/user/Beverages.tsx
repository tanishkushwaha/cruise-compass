...
const Beverages = () => {
    ...
    setData([
      {
        name: 'Coca Cola',
        descr: 'Served Cold',
        imgUrl: 'https://www.coca-cola.com/content/dam/onexp/us/en/brands/coca-cola-original/en_coca-cola-original-taste-20-oz_750x750_v1.jpg',
        price: '$5'
      },
      {
  ...
  return (
    <Container maxW='5xl' p='5rem'>
      <Heading mb='3rem' as='h1'>Beverages</Heading>
