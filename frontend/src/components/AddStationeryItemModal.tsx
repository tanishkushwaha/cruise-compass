...
const AddStationeryItemModal = ({ isOpen, onClose }: PropsType) => {
      ...
      <ModalContent>
        ...
        <ModalBody>
          <Stack direction='column' gap={5}>
            <FormInput label="Enter Item Name" name="ItemName" value={data.ItemName} onChange={handleChange} error={inputErrors.ItemName} />
